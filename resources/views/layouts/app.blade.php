...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ Request::route()->getName() == 'landingPage' ? 'active' : '' }}"
                                aria-current="page" href="{{ route('landingPage') }}">Home</a>
                        </li>
                        <li class="nav-item">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        ...
                                        @endrole
                                        @role('user')
                                            <a href="{{ route('profilUser') }}" class="dropdown-item">Profil</a>
        ...
        <section
            class="{{ Request::route()->getName() == 'favoritList' ? 'fixed-bottom' : '' }} {{ Request::route()->getName() == 'password.request' ? 'd-none' : '' }} {{ Request::route()->getName() == 'password.reset' ? 'd-none' : '' }} {{ Request::route()->getName() == 'login' ? 'd-none' : '' }} {{ Request::route()->getName() == 'register' ? 'd-none' : '' }}">
            <!-- Footer -->
            <footer class="text-center text-white" style="background-color: #0a4275;">
                ...
                <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
                    <a class="text-white" href="{{ route('landingPage') }}">PERPUSTAKAAN DIGITAL</a>
                </div>
                <!-- Copyright -->
            </footer>
            <!-- Footer -->
